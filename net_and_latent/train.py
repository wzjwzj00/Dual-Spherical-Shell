...
def get_args():
    ...
    parser.add_argument('--safe_sphere_dir_path', default='/home/wzj/PycharmProjects/sphere_resconstruct/thingi32_safe4096/', help='sphere dir [default: data/sphere/mesh]')
    parser.add_argument('--inner_sphere_dir_path',default='/home/wzj/PycharmProjects/sphere_resconstruct/thingi32_inner4096/',help='innersphere')
    parser.add_argument('--output_dir_path', default='results/thingi32_4096', help='output_dir_path [default: results/trans]')
    ...
    parser.add_argument('--sphere_num', type=int, default=4096, help='Max sphere num [default:256]')
